...
namespace event_designer.localhost {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ChngpassOperationCompleted;
        ...
        /// <remarks/>
        public event ChngpassCompletedEventHandler ChngpassCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IService1/Chngpass", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void Chngpass([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string uname, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string uemail, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string que, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string ans, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string passwd, out bool ChngpassResult, [System.Xml.Serialization.XmlIgnoreAttribute()] out bool ChngpassResultSpecified) {
            object[] results = this.Invoke("Chngpass", new object[] {
                        uname,
                        uemail,
                        que,
                        ans,
                        passwd});
            ChngpassResult = ((bool)(results[0]));
            ChngpassResultSpecified = ((bool)(results[1]));
        }
        
        /// <remarks/>
        public void ChngpassAsync(string uname, string uemail, string que, string ans, string passwd) {
            this.ChngpassAsync(uname, uemail, que, ans, passwd, null);
        }
        
        /// <remarks/>
        public void ChngpassAsync(string uname, string uemail, string que, string ans, string passwd, object userState) {
            if ((this.ChngpassOperationCompleted == null)) {
                this.ChngpassOperationCompleted = new System.Threading.SendOrPostCallback(this.OnChngpassOperationCompleted);
            }
            this.InvokeAsync("Chngpass", new object[] {
                        uname,
                        uemail,
                        que,
                        ans,
                        passwd}, this.ChngpassOperationCompleted, userState);
        }
        
        private void OnChngpassOperationCompleted(object arg) {
            if ((this.ChngpassCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ChngpassCompleted(this, new ChngpassCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0")]
    public delegate void ChngpassCompletedEventHandler(object sender, ChngpassCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ChngpassCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ChngpassCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public bool ChngpassResult {
            get {
                this.RaiseExceptionIfNecessary();
                return ((bool)(this.results[0]));
            }
        ...
        /// <remarks/>
        public bool ChngpassResultSpecified {
            get {
                this.RaiseExceptionIfNecessary();
                return ((bool)(this.results[1]));
            }
